...
*In the Linux world, most configuration files are plain text in ASCII, so you can modify the Settings with simple text editing software! Unlike Microsoft's Windows, if you're used to Microsoft Word or Corel Wordperfect, you'll find your text editing programs less intuitive and convenient, except for graphical interface editing programs like Xemacs in X Window.*

## 1. vi and vim

There are so many text editors, and we talked about the simple and easy to use Nano in Chapter 5. Now that you've learned the Nano, why bother to learn the not-so-friendly VI? Because:
